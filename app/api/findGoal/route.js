...
const tools = [
    ...
    },
    {
        ...
        function: {
            ...
            description: "Generates advice to achieve the users goal and suggests a goal that is specific, measurable, achievable, and relevant from a general perspective",
            parameters: {
                type: "object",
                properties: {
                    advice: {
                        type: "string",
                        description: "the advice generated by the AI that is short and to the point"
                    },
                    goalSuggestion: { // Add this
                        type: "string",
                        description: "the goal suggestion generated by the AI starting with I suggest and a time frame"
                    }
                },
                required: ["advice", "goalSuggestion"] // Add 'goalSuggestion' here
            }
        }
    }
]
